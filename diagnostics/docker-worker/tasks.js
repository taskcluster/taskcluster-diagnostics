...
/*
This is a parametrized integration test which exercises the following API
endpoints: taskPending, scheduleTask, taskRunning, claimTask, taskComplete,
createArtifact, buildUrl and reportComplete.

Task status is the parameterized value; the test is run for both the passing and
failing case.
*/
        ...
        return helper.queue.createTask(taskId, {
          ...
          metadata: {
            ...
            description:    "Task for docker-worker that tests environment " +
                            "variables and exists with status: " + task_status,
